...
// THIS IS NO MORE OFF USE.  PLACE IS TAKEN BY THE EFFECTS IN THE SCENE SCREEN
//    row 3
//    if (P13 > 10)
//    { tft.setCursor(1, 68); }    
//    else
...
/*---------------------------------------------------------------------------------------------------------------------------------------*/
  ...
  void sceneCursor1()
  { tft.setTextSize(4); tft.setCursor(139, 97); }  
  ...
  { tft.setTextWrap(false);scene_notACTIVEbezel(); 
    tft.setTextColor(sceneStyle4_txt1_color,sceneStyle_notACTIVEbezel); sceneCursor2();}
...
//  { scene_notACTIVEbezel(); tft.setTextColor(sceneStyle4_txt1_color,sceneStyle_notACTIVEbezel); sceneCursor2();}   
//  
...
void printSceneNumbers()
 ...
 {    //strcpy(page, "scene") == 0);
      ...
      tft.fillRoundRect(0, 95, 160, 30, 12, sceneStyle_RECT_fillscreen);    //SMALL ONE
      tft.drawRoundRect(0, 95, 160, 30, 12, sceneStyle_notACTIVEbezelLine); //SMALL ONE
      ...
      tft.fillRoundRect(0, 98, 160, 30, 12, presetUpDown_screen_fillscreen2); //SMALL ONE
      CS5H, CS10H;
}
...
// ===============    3 AND 4 ARE SCENES SCREEN: EFFECT IN BOTTOM OF SCREEN ========================
    void effectStyle3() { //BYPASS
      tft.setTextSize(3);  tft.setCursor(11, 99);
      tft.setTextColor(effectStyle2_txt1_color, effectStyle1_fillscreen); //BLACK, RED
      tft.drawRoundRect(0, 95, 160, 30, 12, sceneStyle_notACTIVEbezelLine);
    }
    ...
    {
      tft.fillRoundRect(0, 95, 160, 30, 12, effectStyle1_fillscreen); effectStyle3(); //RED
    }
  
    void effectOnSceneActive()
    {
      tft.fillRoundRect(0, 95, 160, 30, 12, effectStyle2_fillscreen); effectStyle4(); //Green
    }

    
// ===============    5 AND 6 PRESET UP/DOWN SCREEN: EFFECT IN BOTTOM OF SCREEN ========================
    void effectStyle5() { //BYPASS
      tft.setTextSize(3);  tft.setCursor(16, 104);
      tft.setTextColor(effectStyle2_txt1_color, effectStyle1_fillscreen); //BLACK, RED
    }
    ...
    {
      tft.fillRoundRect(0, 98, 160, 30, 12, effectStyle1_fillscreen); effectStyle5(); //RED
    }
  
    void effectOnPageUpDownActive()
    {
      tft.fillRoundRect(0, 98, 160, 30, 12, effectStyle2_fillscreen); effectStyle6();  //Green
    }
...
void ampABCD_screen()
{
  tft.fillScreen(ampABCD_screenB_fillscreen);
  tft.fillRoundRect(0, 0, 160, 25, 10, TFT_PURPLE);
  ...
  if (strcmp(page, "scene") == 0)
  {
  tft.fillRoundRect(0, 99, 160, 30, 10, TFT_BLUE);   
  tft.setTextColor(TFT_YELLOW, TFT_BLACK);
  tft.setTextSize(2); tft.setCursor(2, 105);  
  tft.println("HOLD = LOOPER"); 
  }
}
...
if (AMP_ABCD_Topscreen11 == 1){ CS11L; AMP_effectScreen_11;  CS11H;}
if (AMP_ABCD_Topscreen12 == 1){ CS12L; AMP_effectScreen_12;  CS12H;}
if (AMP_ABCD_Topscreen14 == 1){ CS14L; AMP_effectScreen_14;  CS14H;}
if (AMP_ABCD_Topscreen15 == 1){ CS15L; AMP_effectScreen_15;  CS15H;}
  }
